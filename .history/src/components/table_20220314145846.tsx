        ...
        <tbody>
          ...
          {registros.map((registro, id) => {
            return (
              <tr key={id}>
                <td>{registro.nome}</td>
                <td>{`${registro.dataCriacao.getDay()}/${registro.dataCriacao.getMonth()}/${registro.dataCriacao.getFullYear()}`}</td>
                <td>{`${registro.ultimaVezModificado.getDay()}/${registro.ultimaVezModificado.getMonth()}/${registro.ultimaVezModificado.getFullYear()}`}</td>
            <td className={styles.actionTd}>
              <button>
                <EditIcon width={24} stroke="none" fill="#641CFD"/>
              </button>
