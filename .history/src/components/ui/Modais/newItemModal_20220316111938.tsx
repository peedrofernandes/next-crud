              ...
              <div className={styles.inputs} key={i}>
                ...
                <div className={styles.inputAndSelect}>
                  ...
                  <select placeholder="Tipo">
                    ...
                    <option value="" onSelect={() => console.log('Number selecionado!')} >Number</option>
                    <option value="" onSelect={() => console.log('Number selecionado!')}>String</option>
                    <option value="" onSelect={() => console.log('Number selecionado!')}>Boolean</option>
                  </select>
                </div>
              </div>
            )
