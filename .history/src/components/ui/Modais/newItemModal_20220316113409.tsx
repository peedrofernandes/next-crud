              ...
              <div className={styles.inputs} key={i}>
                ...
                <div className={styles.inputAndSelect}>
                  ...
                  <select placeholder="Tipo">
                    ...
                    <option value="number" onChange={() => console.log('Number selecionado!')} >Number</option>
                    <option value="string" onSelect={() => console.log('String selecionado!')}>String</option>
                    <option value="boolean" onSelect={() => console.log('Bool selecionado!')}>Boolean</option>
                  </select>
                </div>
              </div>
            )
